...
class Message
{
    ...
    public function sendMessage($user_to, $body, $date)
    {
        if($body != "") {
            ...
            $query = mysqli_query(
                $this->con,
                "INSERT INTO messages VALUES(0, '$user_to', '$userLoggedIn', '$body', '$date', 'no', 'no', 'no')"
            );
        }
    }
    ...
    public function getMessages($otherUser)
    {
        ...
        $query = mysqli_query(
            $this->con,
            "UPDATE messages SET opened='yes' WHERE user_to='$userLoggedIn' AND user_from='$otherUser'"
        );

        $get_messages_query = mysqli_query(
            $this->con,
    ...
    public function getConvos()
    {
        ...
        $query = mysqli_query(
            $this->con,
            "SELECT user_to, user_from FROM messages WHERE user_to='$userLoggedIn' OR user_from='$userLoggedIn' ORDER BY id DESC"
        );
